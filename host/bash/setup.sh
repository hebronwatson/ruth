...
INSTALLED_PACKAGES_FILENAME="$PACKAGES_INFO_DIR/tip.txt";
AVAILABLE_PHP_PACKAGES_FILENAME="$PACKAGES_INFO_DIR/tapp.txt";
AVAILABLE_APACHE_PACKAGES_FILENAME="$PACKAGES_INFO_DIR/taap.txt";
AVAILABLE_MYSQL_PACKAGES_FILENAME="$PACKAGES_INFO_DIR/tamp.txt";
...
function CloneGitRepo(){
	...
	cd /host/www
	test ! -d hoopscore && git clone git@bitbucket.org:hebronwatson/hoopscore.git
}
...
#	@3:	DB_CONFIG_FILENAME:		File Storing Database Config Information for PHP
...
function GitRepoSecrets(){
	...
	cd /host/www	
	test ! -d "hoopscore/$MYSQL_SECRETS_DIR" && mkdir "hoopscore/$MYSQL_SECRETS_DIR"
	#
	# generate the password
	$MYSQL_GENR8D_PASSWORD=$( PHPGeneratePassword "youKnowMe!!!" );
	
	# populate with secrets
	echo $MYSQL_GENR8D_PASSWORD > "/host/www/hoopscore/$MYSQL_SECRETS_DIR/$MYSQL_SECRETS_FILENAME"
	printf "password=$MYSQL_GENR8D_PASSWORD" >> "hoopscore/$MYSQL_SECRETS_DIR/$DB_CONFIG_FILENAME"	
}
